 ...
 */
import type { APIChannel, APIOverwrite } from '@discordjs/builders/node_modules/discord-api-types/payloads/v10/channel';
import type { APIGuildIntegration, GuildDefaultMessageNotifications, GuildExplicitContentFilter, GuildMFALevel, GuildVerificationLevel, IntegrationExpireBehavior } from '@discordjs/builders/node_modules/discord-api-types/payloads/v10/guild';
import type { APIGuildScheduledEvent, GuildScheduledEventEntityType, GuildScheduledEventStatus } from '@discordjs/builders/node_modules/discord-api-types/payloads/v10/guildScheduledEvent';
import type { APIApplicationCommand } from '@discordjs/builders/node_modules/discord-api-types/payloads/v10/interactions';
import type { APIRole } from '@discordjs/builders/node_modules/discord-api-types/payloads/v10/permissions';
import type { StageInstancePrivacyLevel } from '@discordjs/builders/node_modules/discord-api-types/payloads/v10/stageInstance';
import type { StickerFormatType } from '@discordjs/builders/node_modules/discord-api-types/payloads/v10/sticker';
import type { APIUser } from '@discordjs/builders/node_modules/discord-api-types/payloads/v10/user';
import type { APIWebhook } from '@discordjs/builders/node_modules/discord-api-types/payloads/v10/webhook';
